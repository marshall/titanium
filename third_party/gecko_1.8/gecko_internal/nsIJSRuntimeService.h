/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/FirefoxSource.1.5.0.6/mozilla/js/src/xpconnect/idl/nsIJSRuntimeService.idl
 */
...
class NS_NO_VTABLE nsIJSRuntimeService : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IJSRUNTIMESERVICE_IID)

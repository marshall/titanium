/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/moz-1-8-branch/mozilla/js/src/xpconnect/idl/nsIJSContextStack.idl
 */
...
class NS_NO_VTABLE nsIJSContextStackIterator : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IJSCONTEXTSTACKITERATOR_IID)

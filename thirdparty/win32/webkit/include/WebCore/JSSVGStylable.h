...
public:
    JSSVGStylable(PassRefPtr<JSC::Structure>, PassRefPtr<SVGStylable>, SVGElement* context);
...
public:
    ...
    JSSVGStylablePrototype(PassRefPtr<JSC::Structure> structure) : JSC::JSObject(structure) { }
};
